CREATE OR REPLACE PROCEDURE load_accident_units
IS
    /**********************************************************************
    ...
    **********************************************************************/
    ...
    tcntrib_circum_descr                  accident_units.cntrib_circum_descr%TYPE;
    tdirection_of_travel_descr            accident_units.direction_of_travel_descr%TYPE;
    temerg_veh_responding_to_call         accident_units.emerg_veh_responding_to_call%TYPE;
    texempt_vehicle                       accident_units.exempt_vehicle%TYPE;
    textent_of_damage_descr               accident_units.extent_of_damage_descr%TYPE;
    tgvwr_or_gcwr_descr                   accident_units.gvwr_or_gcwr_descr%TYPE;
    thazmat_placard_descr                 accident_units.hazmat_placard_descr%TYPE;
    thit_and_run_descr                    accident_units.hit_and_run_descr%TYPE;
    tlicense_state_descr                  accident_units.license_state_descr%TYPE;
    tmost_harmful_event_descr             accident_units.most_harmful_event_descr%TYPE;
    tnine_or_more_seats_descr             accident_units.nine_or_more_seats_descr%TYPE;
    tprecrash_actions_descr               accident_units.precrash_actions_descr%TYPE;
    tseq_of_events1_descr                 accident_units.seq_of_events1_descr%TYPE;
    tseq_of_events2_descr                 accident_units.seq_of_events2_descr%TYPE;
    tseq_of_events3_descr                 accident_units.seq_of_events3_descr%TYPE;
    tseq_of_events4_descr                 accident_units.seq_of_events4_descr%TYPE;
    tspecial_func_vehicle_descr           accident_units.special_func_vehicle_descr%TYPE;
    tunit_type_descr                      accident_units.unit_type_descr%TYPE;
    tvehicle_config_descr                 accident_units.vehicle_config_descr%TYPE;
    tvehicle_color_descr                  accident_units.vehicle_color_descr%TYPE;
    tvehicle_make_descr                   accident_units.vehicle_make_descr%TYPE;

    tautomation_levels_engaged_descr      accident_units.automation_levels_engaged_descr%TYPE;
    tautomation_levels_in_vehicle_descr   accident_units.automation_levels_in_vehicle_descr%TYPE;
    tautomation_system_in_vehicle         accident_units.automation_system_in_vehicle%TYPE;
    tmost_damaged_area_descr              accident_units.most_damaged_area_descr%TYPE; 
