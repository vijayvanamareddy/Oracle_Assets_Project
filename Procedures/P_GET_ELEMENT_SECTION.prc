CREATE OR REPLACE PROCEDURE P_Get_Element_Section (rte_no IN  VARCHAR2, mp IN NUMBER, ele_id OUT NUMBER, ofset OUT NUMBER, sec_id OUT NUMBER, bmp OUT NUMBER, emp OUT NUMBER)                                  
    IS
