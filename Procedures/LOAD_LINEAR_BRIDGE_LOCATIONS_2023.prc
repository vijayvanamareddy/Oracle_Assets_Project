CREATE OR REPLACE PROCEDURE load_linear_bridge_locations_2023
IS
    /**********************************************************************
    05-05-2023 SH Initial Version
               ...
               Jira Task DOTDW-725
    03-21-24  SH Add snapshot year, added 2023 locations, change truncate to delete for current_year
              SH Run this once to load the 2023 data (requested after this was written)
    12-15-24  SH Delete 2023 not current year, move to production
    **********************************************************************/
