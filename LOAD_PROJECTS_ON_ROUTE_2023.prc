CREATE OR REPLACE PROCEDURE load_projects_on_route_2023
IS
    /**********************************************************************
...
04-17-2024 SH Add snapshot_year column
              Load 2023 data (run this procedure once)
12-13-2024 SH  Add begin_offset, end_offset, workplan_descr, work_status to facilitate the change from project_locations to projects_on_route from obi, delete 2023 data so can reload
    **********************************************************************/
    ...
    LOOP
        INSERT INTO PROJECTS_ON_ROUTE (ASSET_NUMBER,
                ...
                LOG ERRORS INTO PROJECTS_ON_ROUTE_ERROR_LOG
                        ('load_projects_on_route23 ' || g_start_time)
                        REJECT LIMIT 100;
