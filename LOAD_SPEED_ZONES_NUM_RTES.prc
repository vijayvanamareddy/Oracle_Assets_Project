CREATE OR REPLACE PROCEDURE load_speed_zones_num_rtes (
    last_snapshot_year   IN NUMBER)
IS
/**********************************************************************
This procedure uses the dissolve function to create speed zones table for numbered routes
...
BEGIN
    DECLARE
        ...
        g_jobname                 VARCHAR2 (30)
                                      := 'LOAD_SPEED_ZONES_NUM_RTES';
    ...
    BEGIN
        ...
        var_I_WHERE :=
               'snapshot_year = '
            || last_snapshot_year
            || ' AND  SPEEDZN_ID IS NOT NULL and ROUTE_TYPE = ''N''';

        var_I_COLUMNS :=
            'SPEEDZN_ID, ELEMENT_ID, ELEMENT_LENGTH, END_ELEMENT_MILEPOINT, TOWN_NAME, MAINTENANCE_REGION, BEGIN_NODE_ID, BEGIN_NODE_DESCRIPTION, DIRECTION, END_NODE_ID, END_NODE_DESCRIPTION, ROUTE_NAME, SPEED, CUMULATIVE_MILEPOINT_ORDER';
        ...
        -- Numbered routes are not segmented by street
        l_street_name := NULL;
        l_street_prefix := NULL;
        l_street_type := NULL;
        ...
        LOOP
            ...
            Compute_offsets (l_begin_section_mp,
                             l_end_element_milepoint,
                             l_end_section_mp,
                             l_element_length,
                             l_start_offset,
            ...
            INSERT INTO SPEED_ZONES (ASSET,
                    ...
                    LOG ERRORS INTO SPEED_ZONES_ERROR_LOG
                            ('LOAD_SPEED_ZONES_NUM_RTES ' || SYSDATE)
                            REJECT LIMIT 100;
